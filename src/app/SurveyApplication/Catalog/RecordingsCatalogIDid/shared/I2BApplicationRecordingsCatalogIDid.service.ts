...
@Injectable()
export class I2BApplicationRecordingsCatalogIDidService {
  ...
  GetRecordingListByUserID(recordingObj) {
    ...
    return this.httpc.post(GlobalVariable.APIUrl + 'I2BRecordingRequest/GetRequestedFromMe', recordingObj);
  }
