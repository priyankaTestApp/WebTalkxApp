...
@Injectable()
export class I2BApplicationRecordingsCatalogForMyReviewService {
  ...
  GetRecordingListByUserID(recordingObj) {
    ...
    return this.httpc.post(GlobalVariable.APIUrl + 'I2BRecordingRequest/GetAssignedRecordingRequest', recordingObj);
  }
