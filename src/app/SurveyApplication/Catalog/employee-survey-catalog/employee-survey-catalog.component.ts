...
@Component({
  selector: 'app-employee-survey-catalog',
  templateUrl: './employee-survey-catalog.component.html',
  styleUrls: ['./employee-survey-catalog.component.css']
})
export class EmployeeSurveyCatalogComponent implements OnInit {
