...
import { I2BApplicationSavedRequestsModel } from './I2BApplicationSavedRequestsModel.model';
import { HttpClient } from '@angular/common/http';
import { Http } from '@angular/http';
import { GlobalVariable } from '../../../../globals';

@Injectable()
export class I2BApplicationSavedRequestsService {
  ModelProfile: I2BApplicationSavedRequestsModel;
  RecordingRequestList: I2BApplicationSavedRequestsModel[];
